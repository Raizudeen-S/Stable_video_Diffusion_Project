...
repo_id = "stabilityai/stable-video-diffusion-img2vid-xt"  # replace with "stabilityai/stable-video-diffusion-img2vid-xt" or "stabilityai/stable-video-diffusion-img2vid" for other models
filename = "svd_xt.safetensors"  # replace with "svd_xt.safetensors" or "svd.safetensors" for other models
...
version = "svd_xt"  # replace with 'svd_xt' or 'svd' for other models
device = "cuda"
...
def sample(
    input_path: str = "assets/Sample.png",  # Can either be image file or folder with image files
